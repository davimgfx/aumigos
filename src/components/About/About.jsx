  ...
  return (
    <>
      <section
        ...
        <div className="text-[76px] font-bold max-w-[60rem] leading-tight md1090:text-center md1090:w-[auto]">
          <h2>
            Nós fazemos <br />
      ...
      <section className="mt-[10rem] relative section">
        <div className="flex gap-[2rem] items-center justify-between md1090:flex-col">
          <div className="w-[45rem] md1090:w-[auto] md1090:mx-[auto]">
            {/* Title */}
            <div className="text-[76px] font-bold w-[60rem] leading-tight md1090:text-center md1090:w-[auto] md1090:mx-[auto] ">
              <h2 className="">
                Atividades e
            ...
            {/* Description */}
            <p className="text-[16px] text-[#838383]  mt-[1rem] font-bold md1090:text-center md1090:w-[60rem] md1090:mx-[auto]">
              Nossos filhotes e outros cães muito ativos têm muito espaço para
              correr e brincar, além de cobertores confortáveis.
            </p>
            {/* Icons */}
            <div className=" flex gap-[6.5rem] justify-start my-auto flex-wrap mt-[4rem] md1090:justify-center">
